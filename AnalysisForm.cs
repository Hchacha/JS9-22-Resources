...
namespace WindowsFormsApp1
{
    public partial class AnalysisForm : Form
    {
        ...
        private void button1_Click(object sender, EventArgs e)
        {
            ...
            string filePath = path + "\\Resources\\OT_TimetableStatistics.txt";
            //string path = @"C:\Users\Administrator\Desktop\MyDemo\Output\OT_TimetableStatistics.txt";
            //string path = @"D:\田祥龙\能力系统研发\OUTPUT" + @"\OT_TimetableStatistics.txt";//文件路径
            fs = new FileStream(filePath, FileMode.Open, FileAccess.Read);//打开路径对应的文件存入fs
